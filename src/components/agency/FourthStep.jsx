...
const FourthStep = ({ formData, setFormData, validation, setvalidation }) => {
  ...
  useEffect(() => {
    ...
    if (formData.hFirstName === "") {
      ...
      renderCount.current > 0 && setFnRequired("Invalid First Name");
      validationFlag = 0;
    }
    if (formData.hLastName === "") {
      ...
      renderCount.current > 0 && setLnRequired("Invalid Last Name");
      validationFlag = 0;
    }
    if (formData.hEmail === "") {
      ...
      renderCount.current > 0 && setEmRequired("Invalid Email Format");
      validationFlag = 0;
    }
    if (formData.hPhoneNumber === "") {
      ...
      renderCount.current > 0 && setPnRequired("Invalid Phone Number Format");
      validationFlag = 0;
    }
    if (formData.hClientAddress === "") {
      ...
      renderCount.current > 0 && setAdRequired("Invalid Address Format");
      validationFlag = 0;
    }
