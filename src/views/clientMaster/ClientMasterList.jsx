...
import { clientMsDelete, clientMsList } from '../../adapter/ClientmsAdapter.jsx';
...
export default function Clientmasterlist() {
  ...
  const handleEdit = (value) => {
    ...
    //   }
    // });
    navigate("/dashboard/clientmaster/crud", {
    ...
    <>
      <div className="navView">
        ...
        <div className="component-titleContainer">
          <h2 className="component-title">Clientmaster List</h2>
          <Link
            style={{ textDecoration: "none" }}
            to="/dashboard/clientmaster/add">
            <Button
              startIcon={<PersonAdd />}
              color="secondary"
              fullWidth
